...
$resultIDs = mysql_query($querys) or die("Data not found.");

    $rows = mysql_fetch_assoc($resultIDs);
...
$fd = fopen("/var/www/html/42es/@/hr/Data/dataTXT.xml", "w") or die("Can't open file");
