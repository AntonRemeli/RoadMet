...
<?php  
//<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAAsJslf1rg2HPVPtLD-KcKkhTMLht83LKgulkBS0LWCEbw5zu_0hQw-6qdQeu8p6FzqY02W4Zqr12xpg" type="text/javascript"></script>

  // Note: you will need to replace the sensor parameter below with either an explicit true or false value.
?>
  <script src="http://maps.google.com/maps?file=api&amp;v=2&amp;sensor=true&amp;key=ABQIAAAAsJslf1rg2HPVPtLD-KcKkhTMLht83LKgulkBS0LWCEbw5zu_0hQw-6qdQeu8p6FzqY02W4Zqr12xpg" type="text/javascript"></script>
...
<input type="radio" name="gat" value="4" onClick="SetAttr(4)"/> <?php  echo $grsó;?> |
