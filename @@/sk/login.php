...
<br><br><br><br>
<p align="center"><img src="vizitka.jpg" title="Slovenská správa ciest" alt="Slovenská správa ciest" /></p>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="3">
<b><big><big>Cestná meteorológia</b></big></big>
...
<br><b>
<span style="padding:3px; position:relative;  left:30px;"> Kraj:&nbsp;&nbsp;&nbsp;&nbsp; </span>
...
<span style="padding:3px; position:relative;  left:30px;"> UivateŸ:</span>
...
<span style="padding:3px; position:relative;  left:30px;"> Heslo:&nbsp;&nbsp;&nbsp; </span>
...
<input style="padding:5px; position:relative; top:30px; left:107px; width:130px; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:#333333;" type="submit" value="Vstúpte ">
