...
//$query = "SELECT st_id FROM stations  where (st_id>9500 and st_id<9506) or (st_id>9506 and st_id<9530) or (st_id>9530 and st_id<9596)order by st_id ";
/* Select queries return a resultset */
/*
if ($resultID = mysqli_query($link, $query)) {
...
//$query = "SELECT distinct(st_id) FROM utmet.stations  where (st_id>9500 and st_id<9506) or (st_id>9506 and st_id<9530) or (st_id>9530 and st_id<9596) order by st_id ";
//$query = "SELECT distinct(st_id) FROM utmet.stations  where (st_id>9500 and st_id<9506) order by st_id ";
//$query = "SELECT * FROM `stations`  ";


//$resultID = mysqli_query($query) ;
// $resultID = mysqli_query($query) or die("Data not found.");

$xx = mysqli_num_rows($resultID);

echo "xx : ".$xx." . . . ";
//echo "$xx : ".$xx = mysqli_num_rows($resultID);
